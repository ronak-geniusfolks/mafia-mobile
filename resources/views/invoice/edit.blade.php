                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('invoice-update', $invoice->id) }}" method="post" class="@if(count($errors)) was-validated @endif">
                        ...
                        <div class="row">
                            {{-- <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label for="customer_no">Contact No:* <span class="pl-2"><input type="checkbox" name="customer_no_sync" id="customer_no_sync" {{ $invoice->sync_contact ? 'checked' : '' }}><label class="pl-1 mb-0">Would you like to sync with your phone?</label></span></label>
