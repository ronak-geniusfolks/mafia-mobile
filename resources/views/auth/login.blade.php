...
<html lang="en">
    ...
    <body class="authentication-bg authentication-bg-pattern">
                                ...
                                <div class="text-center mb-2">
                                    <div class="auth-logo">
                                        <a href="{{route('login')}}" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="{{asset('assets/images/new_logo/main_logo.png')}}" alt="" height="50">
                                            </span>
                                        </a>
        ...
        <footer class="footer footer-alt">
            2024 -
            <script>document.write(new Date().getFullYear())</script> &copy; <a href="https://www.geniusfolks.in" class="text-white-50" target="_blank">Geniusfolks</a>. All rights reserved.
        </footer>
