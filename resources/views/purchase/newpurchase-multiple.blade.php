                    ...
                    <div class="card-body p-4">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data"
                            ...
                            <div class="border rounded p-2 mb-3 bg-light">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select form-control" id="devicetype" name="device_type"
                                            required>
                                            ...
                                            <option value="Accessories" @selected(old('device_type') == 'Accessories')>
                                                Accessories</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="model" class="form-control form-control" name="model"
                                ...
                                <div class="row mb-3">
                                    {{-- <div class="col-md-6">
                                        ...
                                        <select class="form-select form-control" id="warrenty" name="warrenty"
                                            value="{{ old('warrenty') ?? 'Non warrenty' }}" required>
                                            <option value="Non warrenty" @selected(old('warrenty') == 'Non warrenty')>Non
                                                Warranty</option>
                                            <option value="Warrenty" @selected(old('warrenty') == 'Warrenty')>Warranty
                                            </option>
                                        </select>
                                ...
                                {{-- <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="purchasedate" class="form-label fw-semibold">Purchase Date <span
                                                class="text-danger">*</span></label>
                                        <input type="date" id="purchasedate" class="form-control form-control"
                                ...
                                {{-- <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" id="repairingcharge" class="form-control form-control"
                                            name="repairing_charge" value="{{ old('repairing_charge') }}"
                                            placeholder="Enter Repairing Charge">
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="border-top pt-2">
                                <h5 class="mb-1 fw-bold text-secondary">Stock Items</h5>
                                <div id="stockItems">
                                    <div class="stock-item border rounded p-3 mb-3" data-index="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label class="form-label fw-semibold">IMEI <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="stock_items[0][imei]"
                                                    required>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label fw-semibold">Storage (GB) <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="stock_items[0][storage]"
                                                    required>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label fw-semibold">Color <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="stock_items[0][color]"
                                                    required>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label fw-semibold">Buying Cost <span
                                                        class="text-danger">*</span></label>
                                                <input type="number" class="form-control"
                                                    name="stock_items[0][purchase_cost]" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
